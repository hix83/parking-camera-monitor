...
$config = [
    ...
    // Через сколько секунд без обновления mp4-файлов считаем, что запись архива зависла.
    'recording_stale_threshold' => 900,

    // Сколько секунд даем ffmpeg после старта, прежде чем требовать появления mp4-файлов.
    'recording_startup_grace_seconds' => 360,
